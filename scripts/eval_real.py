...
# ─────────────── 인기 패키지 화이트리스트 ───────────────
# 명단/판정 함수는 src/pkgsentinel/knowledge/popular.py 로 이관 (verdict_rules 와
# 공유). 본 파일에선 import 로만 사용.
from pkgsentinel.knowledge.popular import POPULAR_PYPI, POPULAR_NPM, is_popular as _is_popular
